...
除共识验证者外，承担更高职责的参与方——PayFi 节点、流动性方、高权限 AI 代理、**带单方（带单员）**——可要求锁定**信誉押金**，作恶/违约则罚没（呼应 [C.2](c2-session-keys.md) 有界授权、[E.2](e2-liquidation.md) 违约瀑布）。带单方的信誉押金失职/作恶则罚没进带单准备金池（[E.4.5](e4-reserve-risk.md)），是其损失吸收瀑布的一级。这把「行为约束」从纯技术边界延伸到经济激励：**不仅让作恶在技术上被挡住，也让它在经济上不划算**。
