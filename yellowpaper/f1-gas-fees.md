...
协议手续费收入在链层沉淀，构成 AXON 的真实协议营收（白皮书 [3.1](../part3-architecture/3-1-why-own-l1.md) 的「价值在链层沉淀」）——网络可持续性来自真实业务量（TPV）产生的营收，而非通胀补贴。机制上，部分协议费用可按治理定比例 $\phi_{ct}$ 注入带单准备金池（[E.4.3](e4-reserve-risk.md)），作为其风控缓冲的水源之一；具体分配比例属代币经济，见下。

> 费用收入如何在验证者、协议金库之间分配，以及如何与代币价值捕获关联，属**代币经济**范畴，本黄皮书**不展开**，详见白皮书 [Part VII · 代币经济](../part7-tokenomics/README.md) 的「通缩飞轮」。本节仅规范费用的**计量与定价机制**。
