...
timeline
    ...
    P1 · 主网 Beta（MVP→PMF） : 稳定币即时结算 Rail : 美股带单引擎（首个 PayFi 旗舰产品）· 赋能预测平台生态 : 1–2 个 PayFi 场景（跨境汇款 / 商户收单） : AI 代理支付 SDK（会话密钥）+ 费用代付 : KYC 插件 + 首个支付 / 做市伙伴 : 网络与生态启动
...
* **美股带单引擎**上线——AXON **首个 PayFi 旗舰落地产品**，赋能 Polymarket、Kalshi、Kairos 等预测平台生态，用确定性稳定币收益把外部流量换成真实 TVL 与地址（[4.5](../part4-payfi/4-5-copy-trading-engine.md)）；
...
> **产品优先级**：带单引擎是 AXON 在 PayFi 方向的**首个 GTM 楔子产品**——不是把所有场景一次铺开，而是先用一个流量、收益、闭环都能被真实验证的切口跑通「地基先行、产品切口」的战略。它逻辑上落在 P1（首发旗舰落地）、并在 P2 随 PayFi 网络规模化而放大。
