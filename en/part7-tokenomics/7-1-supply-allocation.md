...
AXON adopts a fixed total supply of 1 billion. **Initial price, FDV, and the TGE float ratio are not disclosed at this time.** Tokens are released per each bucket's independent lock-up and linear-release rules (see [7.2 Vesting & Circulating Supply](7-2-vesting-circulation.md)).
...
| **Liquidity / Market-Making** | **18%** | 180M | Listing liquidity 6-month lock, base pool unlocked; listing liquidity / market-making reserve |
...
pie showData
    ...
    "Airdrop 10%" : 10
    "Liquidity / Market-Making 18%" : 18
```

The **Ecosystem bucket (40%)** is the largest, used for the AI-agent / PayFi ecosystem, liquidity incentives, and the ecosystem fund, released under governance control. It is the funding source for the project-team token incentives of the [6.4 Season 1 · Ecosystem Open Program](../part6-roadmap/6-4-ecosystem-season.md), as well as for various ecosystem building.

> **Disclosure scope**: the Ecosystem bucket is disclosed as a **single aggregate bucket (40%)**; a further breakdown of its internal uses and a more granular release schedule will be disclosed separately at TGE / exchange listing.
...
| **Liquidity / Market-Making** | 18% · listing liquidity 6-month lock, base pool unlocked, used for listing liquidity and market-making |
