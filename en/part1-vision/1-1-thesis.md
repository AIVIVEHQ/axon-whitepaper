...
```mermaid
flowchart LR
    A["Settlement Rail<br/>T+0 · 24/7 · seconds to settle"] --> B["PayFi Network<br/>money market · on-chain credit · AI-agent payments"]
    B --> C["Global Asset Network<br/>asset tokenization · TradFi on-chain (long-term vision)"]
